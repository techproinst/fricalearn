                    ...
                    <tr>
                        <td style="padding: 20px;">
                            ...
                            <ul style="padding-left: 20px;">
                                @forelse ($demoCourseLinks as $link)
                                    <li style="word-break: break-word; overflow-wrap: break-word;">
                                        <a style="text-decoration: none; color: #3b2a56;"
                                            href="{{ $link->demo_course_link }}">
                                ...
                                <tr>
                                    <td bgcolor="#3b2a56" style="border-radius: 5px; text-align: center;">
                                        <a href="{{ route('student.create') }}"
                                            style="display: inline-block; font-size: 16px; font-weight: 500; text-decoration: none; color: #ffffff; background-color: #3b2a56;
