          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                ...
                @php
                $currencySymbol = $key === App\Enums\Continent::OTHER->value ?  App\Enums\Currency::DOLLAR->value :  App\Enums\Currency::NAIRA->value;
                @endphp
                <span>
              ...
              <td>
               ...
               {{--  @include('admin.schedule.classes.delete') --}}
                <div class="d-flex gap-2">
                  <span class="badge bg-primary" data-bs-toggle="modal" data-bs-target="#edit-form{{ $level->id }}"> <i
                      class=" fas fa-edit"></i>
                    Edit</span>
                  <span class="badge bg-danger" data-bs-toggle="modal" data-bs-target="#delete-form{{ $level->id }}">
