                        ...
                        <div class="col-md-9">
                            <div class="tab-content text-muted mt-4 mt-md-0" id="v-pills-tabContent">
                                <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel"
                                    ...
                                    <table id="state-pending-datatable"
                                        ...
                                        <tbody>
                                            @foreach ($pendingPayments as $payment)
                                                <tr>
                                                    ...
                                                    <td><img class="rounded me-2" alt="payment-receipt" width="80"
                                                            src="{{ asset('storage/uploads/' . $payment->payment_receipt) }}"
                                                            data-holder-rendered="true"></td>
                                                    <td><a
                                                            href="{{ route('student.show', ['student' => $payment->student->id]) }}">view
                                                    ...
                                                    <td>
                                                        ...
                                                        <span class="badge bg-primary" data-bs-toggle="modal"
                                                            data-bs-target="#approve-form{{ $payment->id }}"> <i
                                                                class=" fas fa-edit"></i>Approve</span>
                                                        <span class="badge bg-danger" data-bs-toggle="modal"
                                                            data-bs-target="#decline-form{{ $payment->id }}"> <i
                                                                class=" fas fa-trash"></i>Decline</span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                ...
                                <div class="tab-pane fade" id="v-pills-profile" role="tabpanel"
                                    ...
                                    <table id="state-approve-datatable"
                                        class="table activate-select dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                                <th>S/N</th>
                                            ...
                                            @foreach ($approvedPayments as $payment)
                                                <tr>
                                                    ...
                                                    <td><a href="{{ asset('storage/uploads/' . $payment->payment_receipt) }}"
                                                            target="_blank"><img class="rounded me-2" alt="payment-receipt"
                                                                width="80"
                                                                src="{{ asset('storage/uploads/' . $payment->payment_receipt) }}"
                                ...
                                <div class="tab-pane fade" id="v-pills-messages" role="tabpanel"
                                    ...
                                    <table id="state-decline-datatable"
                                        class="table activate-select dt-responsive nowrap w-100">
                                        <thead>
                                            <tr>
                                                <th>S/N</th>
                                        ...
                                        <tbody>
                                            @foreach ($declinedPayments as $payment)
                                                <tr>
                                                    <td>{{ $loop->iteration }}</td>
                                                    <td>{{ $payment->parent->name }}</td>
                                                    @php
...
@section('data_table_script')
    ...
    <script src="{{ asset('assets/scripts/admin/payment.js') }}"></script>
@endsection
