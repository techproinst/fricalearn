          ...
          <div class="col-md-3">
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
              <a class="nav-link mb-2 active" id="v-pills-home-tab" data-bs-toggle="pill" href="#v-pills-home"
                role="tab" aria-controls="v-pills-home" aria-selected="true">Active Subscription</a>
              <a class="nav-link mb-2" id="v-pills-profile-tab" data-bs-toggle="pill" href="#v-pills-profile" role="tab"
                aria-controls="v-pills-profile" aria-selected="false">Expired Subscription</a>
            </div>
          </div>
          <div class="col-md-9">
                ...
                <table id="state-saving-datatable" class="table activate-select dt-responsive nowrap w-100">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="{{ route('student.show', ['student' => $activeSubscription->student->id]) }}">view
                          Student Details</a></td>
                      <td class="text-success">
                        {{ $activeSubscription->is_active ? 'Active' : 'Inactive' }}</td>
                    </tr>
                    @empty
                    <p class="text-danger">No Active subscriptions Available yet!!</p>
                    @endforelse
                ...
                <table id="state-saving-datatable" class="table activate-select dt-responsive nowrap w-100">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><a href="{{ route('student.show', ['student' => $inActiveSubscription->student->id]) }}">view
                          Student Details</a></td>
