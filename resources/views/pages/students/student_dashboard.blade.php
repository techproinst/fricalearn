                ...
                <div
                    ...
                    <div>
                        ...
                        <p>
                            ...
                            @if($studentSchedule->session === App\Enums\Session::MORNING_SESSION->value &&
                            $classSchedule->morning_time)
                            {{$classSchedule->morning_time->setTimezone('UTC')->format('h:i:A')}}
                            @elseif($studentSchedule->session === App\Enums\Session::AFTERNOON_SESSION->value &&
                            $classSchedule->afternoon_time )
                            {{$classSchedule->afternoon_time->setTimezone('UTC')->format('h:i:A')}}
                            @else
                            Time not available yet!!
                            @endif
            ...
            <div class="col-lg-3">
                <div class="card p-4 border-0">
                    ...
                    <div class="d-flex justify-content-between pt-4">
                        ...
                        <a href="" class="text-muted edit-text" data-bs-toggle="modal" data-bs-target="#staticBackdrop"">Edit</a>
                        </div>
                        <div class="">
                    ...
                    <div class="row py-3">
                        ...
                        <div class="col-12 col-md-6 col-lg-4 mb-4">
                            <div class="card shadow-sm border-0 card-radius">
                                ...
                                <div class="card-body">
                                    <div class="">
                                        <button class="level-btn me-2">{{ $resource->courseLevel->level_name }}</button>
