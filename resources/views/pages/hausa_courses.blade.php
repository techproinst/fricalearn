...
<section id="other-courses">
  <div class="container-lg overflow-hidden">
    ...
    <p class="text-muted text-center text-md-start">
     Take your language journey further by exploring our Yoruba and Igbo courses! Each one is designed with the same kid-friendly, engaging style—so your child can discover even more of Africa’s rich cultures and languages in a fun, easy way.
    </p>
