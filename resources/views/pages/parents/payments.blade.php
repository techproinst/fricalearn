                    ...
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="{{ asset('storage/uploads/' . $payment->payment_receipt) }}" target="_blank"><img
                                class="rounded me-2" alt="payment-receipt" width="80"
                                src="{{ asset('storage/uploads/' . $payment->payment_receipt) }}"
                                data-holder-rendered="true"></a></td>
                        </tr>
                        @empty
                        <p class="text-danger">No Approved Payments yet!!</p>
                        @endforelse
                      </tbody>
                    </table>
                  ...
                  <div class="table-responsive">
                    <table class="table table-striped">
                      ...
                      <tbody>
                        ...
                        @empty
                        <p class="text-danger"> No Pending Payments yet!!</p>
                        @endforelse
                      </tbody>
                    </table>
